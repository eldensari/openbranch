    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="gap-4 rounded-2xl p-5 sm:max-w-md">
        ...
        <Input
          ...
          className="h-10 rounded-lg selection:bg-[#3b82f6] selection:text-white focus-visible:ring-[#3b82f6]/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
        />
