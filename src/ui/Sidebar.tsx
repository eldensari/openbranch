        ...
        {!collapsed && (
          <SidebarGroup>
            <button
              ...
              className="group/tag-head flex h-8 w-fit shrink-0 cursor-pointer items-center gap-1 rounded-md px-2 text-sm font-medium text-muted-foreground hover:text-foreground"
            >
              Tags
        ...
        {!collapsed && (
          <SidebarGroup>
            <button
              ...
              className="group/proj-head flex h-8 w-fit shrink-0 cursor-pointer items-center gap-1 rounded-md px-2 text-sm font-medium text-muted-foreground hover:text-foreground"
            >
              Projects
        ...
        {!collapsed && (
          <SidebarGroup>
            <button
              ...
              className="group/chat-head flex h-8 w-fit shrink-0 cursor-pointer items-center gap-1 rounded-md px-2 text-sm font-medium text-muted-foreground hover:text-foreground"
            >
              Recents
