...
import { ChevronDown, ChevronRight, Folder, FolderOpen, FolderPen, MoreHorizontal, PanelLeft, Pencil, Search, Settings, SquarePen, Trash2 } from "lucide-react";
          ...
          <SidebarGroup>
            ...
            {projectsOpen && (
              <div className="flex flex-col px-1">
                ...
                >
                  <FolderPen className="size-4 shrink-0" />
                  New project
                </button>
